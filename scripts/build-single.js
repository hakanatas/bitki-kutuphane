...
const js = ["js/plants.js", "js/illustrate.js", "js/detail.js", "js/seasons.js", "js/app.js"].map(f => fs.readFileSync(path.join(root, f), "utf8")).join("\n");
html = html.replace(/<link rel="stylesheet" href="css\/style.css">\s*<link rel="stylesheet" href="css\/seasons.css">/, () => `<style>\n${css}\n</style>`);
html = html.replace(/<script src="js\/plants.js"><\/script>\s*<script src="js\/illustrate.js"><\/script>\s*<script src="js\/detail.js"><\/script>\s*<script src="js\/seasons.js"><\/script>\s*<script src="js\/app.js"><\/script>/, () => `<script>\n${js}\n</script>`);
